...
this.inputenablecheck=true;
  ...
  this.mainarea.paste(function () { _this.documentsaved=false;  _this.hideTooltip(); _this.removeStyles(); _this.removeNBSP(); _this.marginImgs(); _this.interactionImgs(); make_links_openable(); trytoautosave();});
                ...
                return false;
                    ...
                    if (txtin.length>1 || (e.keyCode==13 && txtin.length>0)) {
                      ...
                      for (f; f>=0; f--) {
                        ...
                        if (current_char==' ' || current_char=='Â¡' || current_char=='Â¿' || current_char==String.fromCharCode(160) || current_char==String.fromCharCode(8195) || current_char==String.fromCharCode(8194) || current_char=='\n') {
            ...
            if (lastchar===String.fromCharCode(0x0022) && _this.lastCharCode=='"') {
             ...
             if (preferencesobj['prsmartquotes']=='pron') {
                ...
                if (txtpos==1 || txtin.slice(txtpos-2,txtpos-1)==' ' || txtin.slice(txtpos-2,txtpos-1)==String.fromCharCode(160)) {
                  ...
                  document.execCommand('insertText',false,'â€š');
                ...
                document.execCommand('insertText',false,'â€˜');
                  ...
                  // El polaco, finlandes y sueco tambiÃ©n es rsquo
                  document.execCommand('insertText',false,'â€™');
                }
...
Editor.fn.removeStyles=function (elm) {
  ...
  elm.getChildren().each(function () {
      ...
      if (this.tagName()=='INPUT' || this.tagName()=='TEXTAREA' || this.tagName()=='SELECT' || this.tagName()=='BUTTON' || this.tagName()=='SCRIPT') {
        this.remove();
